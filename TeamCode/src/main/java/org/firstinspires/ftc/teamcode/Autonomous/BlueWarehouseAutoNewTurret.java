...
@Autonomous
public class BlueWarehouseAutoNewTurret extends LinearOpMode {
            ...
            if(action == 1) {//dropping in correct level
                if (TSEPos == 1) {
                    ...
                    if ((CombinedTurret.vPivotModifiedEncoder >= 875)) {
                        extendSetpoint = 1200;
                        if (CombinedTurret.extendModifiedEncoder <= 1300 && CombinedTurret.extendModifiedEncoder >= 1180) {
                            if (loopcount == 0) {
                                loopcount = 1;
                            ...
                            if (robot.I_DS.getDistance(DistanceUnit.INCH) >= 1 || timepassed <= getRuntime()) {
                                StopMotors();
                                action = 2;
                    ...
                    if (CombinedTurret.vPivotModifiedEncoder >= 875) {
                        extendSetpoint = 1200;
                        if (CombinedTurret.extendModifiedEncoder <= 1350 && CombinedTurret.extendModifiedEncoder >= 1180) {
                            if(loopcount == 0){
                                loopcount = 1;
                                timepassed = getRuntime() + 4;
                            }
                    ...
                    if (CombinedTurret.vPivotModifiedEncoder >= 875) {
                        extendSetpoint = 1200;
                        if (CombinedTurret.extendModifiedEncoder <= 1380 && CombinedTurret.extendModifiedEncoder >= 1180) {
                            if(loopcount == 0){
                                loopcount = 1;
                                timepassed = getRuntime() + 4;
                            }
